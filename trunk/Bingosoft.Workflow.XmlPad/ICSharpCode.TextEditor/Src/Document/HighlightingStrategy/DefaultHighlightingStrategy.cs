...
namespace ICSharpCode.TextEditor.Document
{
	public class DefaultHighlightingStrategy : IHighlightingStrategyUsingRuleSets
	{
		...
		public DefaultHighlightingStrategy(string name)
		{
			...
			environmentColors["LineNumbers"] = new HighlightBackground(Color.FromArgb(43, 145, 175), SystemColors.Window, false, false);
			...
			environmentColors["EOLMarkers"] = new HighlightColor(Color.FromArgb(43, 145, 175), SystemColors.Window, false, false);
			environmentColors["SpaceMarkers"] = new HighlightColor(Color.FromArgb(43, 145, 175), SystemColors.Window, true, false);
			environmentColors["TabMarkers"] = new HighlightColor(Color.FromArgb(43, 145, 175), SystemColors.Window, false, false);
